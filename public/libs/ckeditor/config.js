...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserBrowseUrl = domain + '/base/manager-file/duyet?type=Files';

    config.filebrowserImageBrowseUrl = domain +'/base/manager-file/duyet?type=Images';

    config.filebrowserFlashBrowseUrl = domain +'/base/manager-file/duyet?type=Flash';

    config.filebrowserUploadUrl = domain + '/base/manager-file/ket-noi?command=QuickUpload&type=Files';

    config.filebrowserImageUploadUrl = domain +'/base/manager-file/ket-noi?command=QuickUpload&type=Images';

    config.filebrowserFlashUploadUrl = domain +'/base/manager-file/ket-noi?command=QuickUpload&type=Files';
	config.height = 300;
