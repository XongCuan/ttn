            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <x-core_base::input name="name" :value="$arise->name" readonly />
                    </div>
                    <div class="col-12 col-md-6 mb-3">
                        <label for="" class="form-label">@lang('Số tiền')</label>
                        <x-core_base::input name="amount" :value="number_format($arise->amount)" readonly />
                    </div>
                    <div class="col-12 col-md-6 mb-3">
                        <label for="" class="form-label">@lang('Thời gian')</label>
                        <x-core_base::input name="amount" :value="format_datetime($arise->created_at)" readonly />
                    </div>
                    <div class="col-12">
