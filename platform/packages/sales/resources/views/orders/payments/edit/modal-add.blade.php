<div class="modal fade modal-load-ajax" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <x-core_base::form class="ajax-modal-form-add-payment" action="{{ route('sales.order_payment.store') }}" type="post" :validate="true">
                <x-core_base::input name="order_id" :value="$order_id" type="hidden" />
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <x-core_base::input name="name" :required="true" :placeholder="__('Tên thanh toán')" />
                        </div>
                        <div class="col-12 col-md-6 mb-3">
