                ...
                <div class="d-flex">
                    <div class="">
                        <div class="badge bg-green-lt" data-bs-toggle="tooltip" data-bs-placement="bottom" title="@lang('Mục tiêu')">
                            ...
                            @if($total_revenue['kpi_target'] > 0)
                                <span class="text-green d-inline-flex align-items-center lh-1">
                                    {{ $total_revenue['kpi_target'] }}% 
                                    <i class="ti ti-trending-up"></i>
                                </span>
                            @elseif ($total_revenue['kpi_target'] < 0)
                                <span class="text-danger d-inline-flex align-items-center lh-1">
                                    {{ - $total_revenue['kpi_target'] }}% 
                                    <i class="ti ti-trending-down"></i>
                                </span>
            ...
            <div class="card-body">
                ...
                <div class="d-flex">
                    <div class="">
                        <div class="badge bg-green-lt" data-bs-toggle="tooltip" data-bs-placement="bottom" title="@lang('Mục tiêu')">
                            <i class="ti ti-target-arrow me-1"></i>
                            @if($conversion_rate['kpi_target'] > 0)
                                <span class="text-green d-inline-flex align-items-center lh-1">
                                    {{ $conversion_rate['kpi_target'] }}% 
                                    <i class="ti ti-trending-up"></i>
                                </span>
                            @elseif ($conversion_rate['kpi_target'] < 0)
                                <span class="text-danger d-inline-flex align-items-center lh-1">
                                    {{ - $conversion_rate['kpi_target'] }}% 
                                    <i class="ti ti-trending-down"></i>
                                </span>
