...
{
    public string $nameTable = 'customerTable';
    ...
    {
        $this->columnHasSearch = ['info', 'company', 'short_name', 'tax_code', 'customer_type', 'admin_id', 'assigns', 'created_at'];
    }
    ...
    {
        return Customer::query()->with(['assigns', 'creator']);
    }
    ...
    {
        $this->addColumns = [
            'info' => fn($data) => view('packages_sales::customers.datatables.columns.info')->with('data', $data),
            ...
            'action' => 'packages_sales::customers.datatables.columns.action',
        ];
    }
