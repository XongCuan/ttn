...
use TCore\Sales\DataTables\ContactTypeDataTable;
use TCore\Sales\Http\Requests\ContactTypeRequest;
...
class ContactTypeController extends Controller
{
    ...
    {
        return $datatable->render('packages_sales::contact_types.index', [
    ...
    {
        return view('packages_sales::contact_types.modal.create');
    }
    ...
    {
        return view('packages_sales::contact_types.modal.edit')->with('data', $this->model->findOrFail($id));
    }
