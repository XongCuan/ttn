...
use TCore\Sales\DataTables\RangePriceDataTable;
use TCore\Sales\Http\Requests\RangePriceRequest;
...
class RangePriceController extends Controller
{
    ...
    {
        return $datatable->render('packages_sales::range_prices.index', [
    ...
    {
        return view('packages_sales::range_prices.modal.create');
    }
    ...
    {
        return view('packages_sales::range_prices.modal.edit')->with('data', $this->model->findOrFail($id));
    }
