<div class="modal modal-blur fade modal-load-ajax" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <x-core_base::form class="ajax-modal-form" :action="route('webadmin.project_requirement.update_change_status')" type="put" :validate="true"
                data-load-dt="true" data-table-id="pRequirementTable">
                <input type="hidden" name="id" value="{{ $data->id }}">
                <div class="modal-header">
                    <div class="modal-title">@lang('Trạng thái')</div>
                </div>
