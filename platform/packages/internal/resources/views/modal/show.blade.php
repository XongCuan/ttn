    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label fw-bold">@lang('Ngày bắt đầu')</label>
                        <p>{{ format_date($data->start_date, 'd/m/Y') }}</p>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-bold">@lang('Ngày kết thúc')</label>
                        <p>{{ format_date($data->end_date, 'd/m/Y') }}</p>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
