<div class="modal modal-blur fade modal-load-ajax" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <x-core_base::form class="ajax-modal-form" :action="route('workingtime_ticket.store')" type="post" :validate="true" data-load-dt="true" data-table-id="workingtimeTicket">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <x-core_base::input type="date" name="ticket_date" :required="true"
                            :placeholder="__('Date')" />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <x-core_base::input.filepond name="attachment_path" style="opacity: 0" />
                    </div>
                </div>
