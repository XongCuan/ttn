...
namespace TCore\Outsource\Http\Requests;
...
class ProjectRequest extends Request
{
    protected function methodPost()
    {
        return [
            ...
            'requirement_id' => ['nullable', 'exists:App\Models\ProjectRequirement,id'],
            'name' => ['required'],
            'start_date' => ['nullable', 'date_format:Y-m-d'],
            'end_date' => ['nullable', 'date_format:Y-m-d'],
            'desc' => ['nullable'],
            'scale' => ['required', new Enum(ProjectScale::class)],
            'priority' => ['nullable', new Enum(ProjectPriority::class)],
            'team_id' => ['nullable', 'exists:App\Models\Team,id'],
            'assigns' => ['nullable', 'array'],
            'assigns.*' => ['nullable', 'exists:App\Models\Admin,id']
        ];
    }

    protected function methodPut()
    {
        if ($this->routeIs('outsource.project.update_change_status')) {
            return [
