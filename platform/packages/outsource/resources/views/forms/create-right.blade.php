    ...
    <div class="card mt-3">
        ...
        <div class="card-body p-2">
            <x-core_base::select class="select2-bs5-ajax-many select2-condition"
                data-condition="select[name='assigns[]']" name="team_id" :data-url="route('outsource.select_team')">
            </x-core_base::select>
        </div>
    </div>
    <div class="card mt-3">
        ...
        <div class="card-body p-2">
            <x-core_base::select class="select2-bs5-ajax-many" name="assigns[]" :data-url="route('outsource.select_employee', 0)" :multiple="true">
            </x-core_base::select>
        </div>
    </div>
</div>
