<div style="white-space: nowrap;">
    <button type="button" data-route="{{ route('outsource.project.change_status', $id) }}"
        class="btn btn-icon btn-info open-modal-form" data-load-dt="true" data-table-id="projectTable">
        <i class="ti ti-progress"></i>
    </button>

    <button type="button" data-route="{{ route('outsource.project.show', $id) }}"
    ...
    @if (get_auth_admin()->hasLeaderShipRoleOutsource())
        <a href="{{ route('outsource.project.edit', $id) }}" class="btn btn-icon btn-warning">
            <i class="ti ti-edit"></i>
        </a>
        <button class="btn btn-icon btn-danger open-modal-delete" data-load-dt="true" data-table-id="projectTable"
            data-route="{{ route('outsource.project.delete', $id) }}" data-target="#modalAjaxDelete">
