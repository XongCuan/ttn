<div class="modal modal-blur fade modal-load-ajax" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <x-core_base::form class="ajax-modal-form" :action="route('marketing.source.store')" type="post" :validate="true" data-load-dt="true" data-table-id="sourceTable">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <x-core_base::input name="name" :required="true" :placeholder="trans('Tên nguồn')" />
                    </div>
                    <div class="mb-3">
