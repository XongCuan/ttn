...
use TCore\Marketing\DataTables\SourceDataTable;
use TCore\Marketing\Http\Requests\SourceRequest;
...
class SourceController extends Controller
{
    ...
    {
        return $datatable->render('packages_marketing::sources.index', [
    ...
    {
        return view('packages_marketing::sources.modal.create');
    }
    ...
    {
        return view('packages_marketing::sources.modal.edit')->with('data', $this->model->findOrFail($id));
    }
